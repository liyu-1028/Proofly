 ...
 * 更新员工状态
 */
export function updateUserStatus(userId: number, status: 'active' | 'disabled' | 'locked') {
 ...
 * 重置员工密码
 */
export function resetUserPassword(userId: number, payload: UserResetPasswordRequest) {
